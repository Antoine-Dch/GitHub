...
> repositories
> new
> Repository name: JSON, choose Public or Private, Initialize (если требуется)
> create repository
...
> Code
> Https
> Копировать ссылку на репозиторий
> На компьютере открыть GitBash
...
> repositories
> new
> Repository name: XML, choose Public or Private, Initialize (если требуется)
> create repository
...
> repositories
> new
> Repository name: TXT, choose Public or Private, Initialize (если требуется)
> create repository
